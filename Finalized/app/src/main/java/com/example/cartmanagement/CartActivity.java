...
import com.example.cartmanagement.adapter.MyCartAdapter;
...
//Fetch  the details from the firebase
...
cartLoadListener.onCartLoadFailed(error.getMessage());
    ...
    private void init(){
        ...
        recycleCart.addItemDecoration(new DividerItemDecoration(this,layoutManager.getOrientation()));

        btnBack.setOnClickListener(v-> finish());
    }
//Calculate the Total Amount of item
    @Override
    public void onCartLoadSuccess(List<CartModel> cartModelList) {
        ...
        txtTotal.setText(new StringBuilder("TOTAL AMOUNT : LKR  ").append(sum));
