...
public class rent_request_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rent_request_screen);
    ...
    public void addRentRequest(request_rent item){
        ...
        CollectionReference dbRentItem = db.collection("request_rent_item");

        dbRentItem.add(item).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            @Override
            public void onSuccess(DocumentReference documentReference) {
                progressDialog.dismiss();
                Toast.makeText(rent_request_screen.this, "Your Request Has Been Added", Toast.LENGTH_SHORT).show();

                Intent i = new Intent(rent_request_screen.this,MainActivity.class);
                rent_request_screen.this.startActivity(i);
                rent_request_screen.this.finish();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(rent_request_screen.this, "Fail To Add Request \n" + e, Toast.LENGTH_SHORT).show();
            }
        });
    }
}