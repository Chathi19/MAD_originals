...
public class rent_list_screen extends AppCompatActivity {


    RecyclerView itemListView;
    ArrayList<rentItem> rentItemArrayList;
    rent_item_Adapter item_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rent_list_screen);
        ...
        item_adapter = new rent_item_Adapter(rentItemArrayList, this);
        ...
        db.collection("rent_item").get()
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        if (!queryDocumentSnapshots.isEmpty()) {
                           ...
                           // loadingPB.setVisibility(View.GONE);
                            ...
                            Toast.makeText(rent_list_screen.this, "No data found in Database", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                progressDialog.dismiss();
                Toast.makeText(rent_list_screen.this, "Fail to get the data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}