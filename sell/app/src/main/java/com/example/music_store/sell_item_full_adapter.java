...
public class sell_item_full_adapter extends RecyclerView.Adapter<sell_item_full_adapter.ViewHolder> {
    ...
    public sell_item_full_adapter(ArrayList<rentItem> itemArrayList, Context context) {
    ...
    @NonNull
    @Override
    public sell_item_full_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new sell_item_full_adapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.single_sell_item_details_fragment, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull sell_item_full_adapter.ViewHolder holder, int position) {
        ...
        holder.buttonEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(context, edit_sell_item_screen.class);
