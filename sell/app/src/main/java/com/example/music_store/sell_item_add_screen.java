...
public class sell_item_add_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sell_item_add_screen);
        ...
        databaseReference = firebaseDatabase.getReference("sell_item");
        ...
        ref.putFile(uri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e)
                    {
                        ...
                        Toast
                                .makeText(sell_item_add_screen.this,
                                        "Failed " + e.getMessage(),
                                        Toast.LENGTH_SHORT)
                                .show();
                    }
    ...
    public void addDatas(rentItem item, UploadTask.TaskSnapshot taskSnapshot, ProgressDialog progressDialog){
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(sell_item_add_screen.this, "data added", Toast.LENGTH_SHORT).show();
//                progressDialog.dismiss();
//                Toast
...
//                        .show();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(sell_item_add_screen.this, "Fail to add data " + error, Toast.LENGTH_SHORT).show();
//                progressDialog.dismiss();
//                Toast
//                        .makeText(rent_item_add_screen.this,
//                                "Image Uploaded & Fail to add data !!",
...
//                        .show();
    ...
    public void saveDatas(rentItem item,  ProgressDialog progressDialog){
        CollectionReference dbRentItem = db.collection("sell_item");
        ...
        dbRentItem.add(item).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            ...
            public void onSuccess(DocumentReference documentReference) {
                progressDialog.dismiss();
                Toast.makeText(sell_item_add_screen.this, "Your Course has been added to Firebase Firestore", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(sell_item_add_screen.this, "Fail to add course \n" + e, Toast.LENGTH_SHORT).show();
            }
        });
