...
public class edit_sell_item_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_sell_item_screen);
        ...
        ref.putFile(uri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e)
                    {
                        ...
                        Toast
                                .makeText(edit_sell_item_screen.this,
                                        "Failed " + e.getMessage(),
                                        Toast.LENGTH_SHORT)
                                .show();
                    }
        ...
        db.collection("sell_item").
                ...
                // calling a method for on success listener.
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(edit_sell_item_screen.this, "Course has been updated..", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(edit_sell_item_screen.this, "Fail to update the data..", Toast.LENGTH_SHORT).show();
            }
        });
    }
