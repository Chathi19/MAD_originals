...
public class admin_sell_list_view extends AppCompatActivity {

    RecyclerView itemListView;
    ArrayList<rentItem> rentItemArrayList;
    sell_item_full_adapter item_adapter;
    FirebaseFirestore db;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_sell_list_view);
        ...
        item_adapter = new sell_item_full_adapter(rentItemArrayList, this);
        ...
        db.collection("sell_item").get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(admin_sell_list_view.this, "No data found in Database", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                progressDialog.dismiss();
                Toast.makeText(admin_sell_list_view.this, "Fail to get the data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}